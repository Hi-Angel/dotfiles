...
(custom-set-faces
 ...
 '(font-lock-comment-face ((t (:foreground "dim gray" :slant italic :weight bold :height 105))))
 '(font-lock-doc-face ((t (:foreground "blue"))))
 '(font-lock-doc-string-face ((t (:foreground "medium blue" :slant italic :height 95))))
 ...
 '(font-lock-type-face ((t (:foreground "ForestGreen" :height 105))))
