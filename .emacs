...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-mode undo-fu yaml-mode undo-tree xr symbol-overlay evil-magit smex irony winum company company-ngram flycheck-rust php-mode htmlize csharp-mode meson-mode rust-mode flycheck ess minizinc-mode rainbow-delimiters atom-dark-theme highlight-numbers color-identifiers-mode company-anaconda anaconda-mode markdown-mode wrap-region smartparens slime pretty-symbols paredit lua-mode indent-guide idomenu highlight-parentheses helm-company ggtags flycheck-irony flycheck-haskell evil ctypes company-irony cmake-mode autopair evil-surround))
